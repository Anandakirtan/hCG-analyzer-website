...
const lower_hcg_by_day = {
    ...
    42: 28000,
    ...createDayRange(43, 48, 28000),
    ...createDayRange(49, 84, 20000)
};

// Upper reference ranges
const upper_hcg_by_day = {
    ...
    42: 128000,
    ...createDayRange(43, 55, 200000),
    ...createDayRange(56, 62, 100000),
    ...createDayRange(63, 76, 95000),
    ...createDayRange(77, 84, 90000)
};

// Median reference ranges
const median_hcg_by_day = {
    ...
    47: 90000, 48: 80000,
    ...createDayRange(49, 55, 70000),
    ...createDayRange(56, 62, 65000),
    ...createDayRange(63, 69, 60000),
    ...createDayRange(70, 76, 55000),
    ...createDayRange(77, 84, 45000)
};
